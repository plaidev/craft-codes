...
export default async function (data, { MODULES }) {
  ...
  const aboutProduct = data.jsonPayload.data.about_product;
  const howToBuy = data.jsonPayload.data.how_to_buy;
  const freeComment = data.jsonPayload.data.free_comment;
