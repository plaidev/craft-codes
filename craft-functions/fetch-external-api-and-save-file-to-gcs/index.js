...
async function uploadDataToStorage(bucketName, filePath, jsonLinesData, jsonKey, logger) {
...
export default async function (data, { MODULES }) {
  ...
  await uploadDataToStorage(BUCKET_NAME, FILE_PATH, formattedData, jsonKey, logger);
}
